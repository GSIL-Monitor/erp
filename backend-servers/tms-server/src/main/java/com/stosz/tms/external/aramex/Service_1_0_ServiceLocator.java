...
public class Service_1_0_ServiceLocator extends org.apache.axis.client.Service implements com.stosz.tms.external.aramex.Service_1_0_Service {
    ...
    public com.stosz.tms.external.aramex.Service_1_0_PortType getBasicHttpBinding_Service_1_0() throws javax.xml.rpc.ServiceException {
    ...
    public com.stosz.tms.external.aramex.Service_1_0_PortType getBasicHttpBinding_Service_1_0(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.stosz.tms.external.aramex.BasicHttpBinding_Service_1_0Stub _stub = new com.stosz.tms.external.aramex.BasicHttpBinding_Service_1_0Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.stosz.tms.external.aramex.Service_1_0_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.stosz.tms.external.aramex.BasicHttpBinding_Service_1_0Stub _stub = new com.stosz.tms.external.aramex.BasicHttpBinding_Service_1_0Stub(new java.net.URL(BasicHttpBinding_Service_1_0_address), this);
                _stub.setPortName(getBasicHttpBinding_Service_1_0WSDDServiceName());
                return _stub;
            }
        }
