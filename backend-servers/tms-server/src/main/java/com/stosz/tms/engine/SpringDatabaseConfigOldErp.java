...
@Component
public class SpringDatabaseConfigOldErp extends SpringDatabaseConfigAbstract {

	public static final Logger logger = LoggerFactory.getLogger(SpringDatabaseConfigOldErp.class);

	@Value("${oldErp.jdbc.driver}")
	...
	@Value("${oldErp.c3p0.minPoolSize}")
	private Integer c3p0_minPoolSize;
	@Value("${oldErp.c3p0.maxPoolSize}")
	private Integer c3p0_maxPoolSize;
	@Value("${oldErp.c3p0.initialPoolSize}")
	private Integer c3p0_initialPoolSize;
	@Value("${oldErp.c3p0.maxIdleTime}")
	private Integer c3p0_maxIdleTime;
	@Value("${oldErp.c3p0.acquireIncrement}")
	private Integer c3p0_acquireIncrement;
	@Value("${oldErp.c3p0.idleConnectionTestPeriod}")
	private Integer c3p0_idleConnectionTestPeriod;
	@Value("${oldErp.c3p0.acquireRetryAttempts}")
	private Integer c3p0_acquireRetryAttempts;
	@Value("${oldErp.c3p0.maxStatements}")
	private Integer c3p0_maxStatements;
	@Value("${oldErp.c3p0.maxStatementsPerConnection}")
	private Integer c3p0_maxStatementsPerConnection;
	@Value("${oldErp.c3p0.checkoutTimeout}")
	private Integer c3p0_checkoutTimeout;

	// @Value("${olderp.mybatis.mapperLocations}")
