...
import com.stosz.purchase.sync.mq.OrderRequiredHandler;
...
//        jacsonConverter.getSupportedMediaTypes().add(MediaType.ALL);
    ...
    protected ConcurrentHashMap<String, List<AbstractHandler>> rabbitMessageHandlerMap() {
        ...
        concurrentHashMap.putIfAbsent("qcOrderPurchase",Arrays.asList(springContextHolder.getBean(OrderRequiredHandler.class)));
