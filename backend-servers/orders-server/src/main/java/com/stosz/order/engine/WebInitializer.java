...
public class WebInitializer extends AbstractAnnotationConfigDispatcherServletInitializer {
    ...
    protected Class<?>[] getRootConfigClasses() {
        ...
        return new Class<?>[]{SpringRootConfig.class, AdminConsumer.class, ProductConsumer.class, StoreConsumer.class,TmsConsumer.class};
    }

    @Override
    protected Class<?>[] getServletConfigClasses() {
        return new Class<?>[] { SpringWebMvcConfig.class,OrderProvider.class};
    }
