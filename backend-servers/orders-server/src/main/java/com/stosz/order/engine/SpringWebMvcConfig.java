...
//    }
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(clientLoginInterceptor).addPathPatterns("/**").excludePathPatterns( "/orders/remote/*").excludePathPatterns("/test/**").excludePathPatterns("/").excludePathPatterns("/orders/wms/api/*");
    }
