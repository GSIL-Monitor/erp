...
import com.stosz.admin.interceptor.AdminLoginInterceptor;
...
//    private LoginUserResolver loginUserResolver;
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(loginInterceptor).addPathPatterns("/**").excludePathPatterns("/static/**", "/admin/remote/*", "/login","/admin/getUserByTicket/*");
    }
