...
<template scope='app'>
    ...
    <control-table tablekey='table' :app='app' style='width: 100%;' :loading='app.controls.table.loading'>
        ...
        <%--</template>--%>
        <%--</el-table-column>--%>
        <%--<el-table-column prop='zoneCode' label='语言编码'  width='150'>--%>
        <%--<template scope='inner'>--%>
        ...
        <p style="margin: 0;padding: 0;">订单号:{{inner.row.orderNo}}</p>
        ...
        <el-table-column label="订单状态" width='100' prop="orderStatusEnumStateName">
        <!--111-->
        <%--<template scope='inner'>--%>
        <%--<control-item :app='app' :local='inner.row' datakey='sort' type='edit'--%>
        <%--@saved='app.controls.table.doUpdate(inner.row)' @discard='app.controls.table.refresh()'--%>
        ...
        <el-table-column label="支付方式" width='100' prop="paymentMethodStateName">
        ...
        :app='app.controls.app'
        :local='inner.row'
        datakey='getDisplay'></control-item>
        ...
        <!--- 11-->
        <%--<el-button type='primary' size='mini' @click='app.controls.table.doUpdate(inner.row)'--%>
        <%--:disabled='!app.controls.app.Perm.write'>子类别--%>
        <%--</el-button>--%>
        <!----111-->
        </el-table-column>
    </control-table>
