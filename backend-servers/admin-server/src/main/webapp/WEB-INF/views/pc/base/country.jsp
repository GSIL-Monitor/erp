...
<body>
  ...
  <template scope='app'>
      <control-table tablekey='table' :app='app' style='width: 1000px'  autoresize='width - 200' :loading='app.controls.table.loading'>
            ...
            <el-table-column prop='name' label='国家编码'>
                <template scope='inner'>
                    <control-item :app='app' :local='inner.row' datakey='countryCode' type='edit'
                                  @saved='app.controls.table.doUpdate(inner.row)'
                                  @discard='app.controls.table.refresh()'
                                  :item-disabled='!app.controls.app.Perm.write'></control-item>
                </template>
            ...
            <el-table-column prop='currencyCode' label='币种编码'>
                <template scope='inner'>
                    <control-item :app='app' :local='inner.row' datakey='currencyCode' type='edit'
                                  @saved='app.controls.table.doUpdate(inner.row)'
                                  @discard='app.controls.table.refresh()'
                                  :item-disabled='!app.controls.app.Perm.write'></control-item>
                </template>
      ...
      <template scope='app'>
            <el-card>
                    ...
                    <el-row><el-col><control-item :app='app.controls.app' type='input' :local='app.controls.table.add' datakey='countryCode' label='国家编码'></control-item></el-col></el-row>
                    <el-row><el-col><control-item :app='app.controls.app' type='input' :local='app.controls.table.add' datakey='currencyCode' label='币种编码'></control-item></el-col></el-row>
            </el-card>
      </template>
    </dialog-create>
  </template>
