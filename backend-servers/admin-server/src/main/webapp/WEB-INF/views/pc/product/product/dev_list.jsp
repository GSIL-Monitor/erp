...
<template scope='app'>
    <control-table :app='app' :style="`width: ${app.window.innerWidth - 250}  px;`" tablekey='product_table'
        ...
        <template scope='app' slot='controls'>
            ...
            <el-row>
                <el-col :span='4' style='padding: 5px 15px;'>
                    <control-item type='select' :listfunc='app.controls.app.enum' listkey='ProductState'
                                  :local='app.local.searchParams' datakey='state'
                ...
                <el-col :span='4' style='padding: 5px 15px;'>
                    <%-- <control-item type='select' :listfunc='app.controls.app.firstCategoryListFunc' listkey=''
                                   :local='app.local.searchParams' datakey='categoryIds'
                                   label='一级品类'></control-item>--%>
                    <control-item :local='app.local.searchParams'
                                  :list='app.controls.product_table.catelist'
                                  datakey='categoryIds' label='分类' type='selectcascade'
                                  select-leaf
                    ></control-item>
                </el-col>
...
//                }
            ...
            showDetail(row){
                window.top.app.open('/product/product/product/dev_detailsPage?id=' + row.id + "&iframe=" + row.id);
                /*
