                            ...
                            <span slot="footer" class="dialog-footer">
                                            <el-button
                                                ...
                                                <el-button type="primary"
                                                            @click="window.app.controls.c.submit(item)"
                                                            v-loading.fullscreen.lock="window.app.controls.c.fullscreenLoading">确 定</el-button>
                            </span>
                        </el-dialog>
                        <br>
                ...
                <el-row style='padding: 15px 5px;  border: 2px dashed grey;'>
                    <div style='display: flex; flex-flow: row wrap;'>
                        <draggable v-model='item'
                            ...
                            <el-button v-for='b in item' :data-id='b.id' class='v-c' :data-title='b.title' size='mini'
                                       style='margin-bottom: 5px;' v-if='!b.bindIs'>
                                {{b.title}}
                            </el-button>
                        </draggable>
...
<js>
    ...
    <script>
        ...
        window.layoutData.controls.p = {
            get() {
                app.ajax.product.approveDetail({id: app.id}).then(x => {
