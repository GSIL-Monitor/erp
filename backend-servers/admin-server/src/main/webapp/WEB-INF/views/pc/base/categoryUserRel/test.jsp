            ...
            <control-table :app='app' tablekey='usertable' style='width: 1000px;' :loading='app.controls.usertable.loading'>
                <template scope='app' slot='controls'>
                    <el-row>
                        ...
                        <el-col :span='8'>
                            <control-item type='select'
                                          ...
                                          :treetolist='true'
                                          :listfunc='app.controls.app.firstCategoryListFunc' listkey='1' :local='app.local.searchParams' datakey='categoryId' label='品类'></control-item>
                        </el-col>
                        <el-col :span='8'>
                    ...
                    <el-row>
                        ...
                        <el-col :span='8'>
                            <control-item type='select' :list='app.controls.usertable.typelist' :local='app.local.searchParams' datakey='userType' label='用户分类'>
                            </control-item>
                        </el-col>
                        <el-col :span='8'>
                ...
                <el-card>
                    ...
                    <el-col>
                        <control-item type='select'
                                      :treelistprops='{key: "key", value: "value", children: "children"}'
                                      :treetolist='true'
                                      :listfunc='app.controls.app.firstCategoryListFunc' listkey='1' :local='app.controls.usertable.add' datakey='categoryId' label='一级品类'></control-item>
                    </el-col>
                    <el-col>
                        <control-item type='select'
                                      :treelistprops='{key: "key", value: "value", children: "children"}'
