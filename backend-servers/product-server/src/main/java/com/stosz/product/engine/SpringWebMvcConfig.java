...
//    private LoginUserResolver loginUserResolver;
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(clientLoginInterceptor).addPathPatterns("/**").excludePathPatterns("/", "/static/**", "/*/remote/*","/**/list");
    }
...
//    }
	...
	public void configureMessageConverters(List<HttpMessageConverter<?>> converters) {
        ...
        //防xss
        jsonConverter.getObjectMapper().getFactory().setCharacterEscapes(new CharacterEscapes(){
            @Override
