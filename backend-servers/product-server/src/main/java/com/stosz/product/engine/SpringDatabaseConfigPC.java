...
@Component
public class SpringDatabaseConfigPC extends SpringDatabaseConfigAbstract {
    private static final Logger logger = LoggerFactory.getLogger(SpringDatabaseConfigPC.class);
    @Value("${mysql.jdbc.driver}")
    public String jdbcDriver;
    @Value("${pc.jdbc.url}")
    public String jdbcUrl;
    @Value("${pc.jdbc.username}")
    public String jdbcUsername;
    @Value("${pc.jdbc.password}")
    public String jdbcPassword;

    @Value("${pc.c3p0.minPoolSize}")
    public Integer c3p0_minPoolSize;
    @Value("${pc.c3p0.maxPoolSize}")
    public Integer c3p0_maxPoolSize;
    @Value("${pc.c3p0.initialPoolSize}")
    public Integer c3p0_initialPoolSize;
    @Value("${pc.c3p0.maxIdleTime}")
    public Integer c3p0_maxIdleTime;
    @Value("${pc.c3p0.acquireIncrement}")
    public Integer c3p0_acquireIncrement;
    @Value("${pc.c3p0.idleConnectionTestPeriod}")
    public Integer c3p0_idleConnectionTestPeriod;
    @Value("${pc.c3p0.acquireRetryAttempts}")
    public Integer c3p0_acquireRetryAttempts;
    @Value("${pc.c3p0.maxStatements}")
    public Integer c3p0_maxStatements;
    @Value("${pc.c3p0.maxStatementsPerConnection}")
    public Integer c3p0_maxStatementsPerConnection;
    @Value("${pc.c3p0.checkoutTimeout}")
    public Integer c3p0_checkoutTimeout;

    @Value("${pc.mybatis.mapperLocations}")
