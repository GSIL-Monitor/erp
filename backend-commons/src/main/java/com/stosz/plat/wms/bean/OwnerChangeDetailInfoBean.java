 ...
 *
 */
public class OwnerChangeDetailInfoBean {
	/*
	 * 来源货主
	 */
	private String fowna;
	/*
	 * 目标货主
	 */
	private String oowna;
	/*
	 * Sku编码
	 */
	private String sku;	
	...
	public String getFowna() {
		return fowna;
	}
	public void setFowna(String fowna) {
		this.fowna = fowna;
	}
	public String getOowna() {
		return oowna;
	}
	public void setOowna(String oowna) {
		this.oowna = oowna;
	}
