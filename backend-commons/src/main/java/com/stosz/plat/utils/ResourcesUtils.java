...
public class ResourcesUtils {
    ...
    /**
     * Load a given resource. This method will try to load the resource using the following methods
     * (in order):
     * <ul>
    ...
    public static URL getResource(String resourceName, Class<?> callingClass) {
        ...
        ClassLoader cluClassloader = ResourcesUtils.class.getClassLoader();
